...
async function renderModalDetail(id) {
    ...
    if (pending.includes('W-DFM_SUB')) {
        ...
        $('#input1').html(`<input type="file" class="form-control form-control-sm datepicker is-invalid" name="DFMMaker"\>`)
    ...
    if (pending.includes('W-DFM_PAE_CHECK')) {
        ...
        $('#input2').html(`<input type="file" class="form-control form-control-sm datepicker is-invalid" name="DFMPAEChecked"\>`)
    ...
    if (pending.includes('W-DFM_PE1_CHECK')) {
        ...
        $('#name2').text('Upload DFM').addClass('text-danger')
        $('#input2').html(`<input type="file" class="form-control form-control-sm datepicker is-invalid" name="DFMPE1Checked"\>`)
    }
    ...
    if (pending.includes('W-DFM_PE1_APP')) {
        ...
        $('#name2').text('Upload DFM').addClass('text-danger')
        $('#input2').html(`<input type="file" class="form-control form-control-sm datepicker is-invalid" name="DFMPE1App"\>`)
    }
    ...
    if (pending.includes('W-DFM_PAE_APP')) {
        ...
        $('#name2').text('Upload DFM').addClass('text-danger')
        $('#input2').html(`<input type="file" class="form-control form-control-sm datepicker is-invalid" name="DFMPAEApp"\>`)
    }
